...
const Cfst = {
  generateContent() {
    ...
    contentTxt.innerText = `CarFast is a web application that connects car sellers with car buyers. CarFast allows the user to manage a vehicle inventory through CRUD operations on different data models such as cars, makes, models, etc. It supports image storage and optimization and takes advantage of relevant APIs to gather exhaustive information on each car. CarFast uses Node.js and MongoDB to deliver a SSR fullstack solution.`;
    ...
    link.innerText = "https://carfast-production.up.railway.app/inventory";
    link.setAttribute(
      "href",
      "https://carfast-production.up.railway.app/inventory"
    );
